...
final class Routes: RouteCollection {
    ...
    func build(_ builder: RouteBuilder) throws {
        try addViewRoutes(builder)
        try addApiRoutes(builder)
    ...
    private func addApiRoutes(_ builder: RouteBuilder) throws {
    ...
    private func addViewRoutes(_ builder: RouteBuilder) throws {
        builder.get {req in
